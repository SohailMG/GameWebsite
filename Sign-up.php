...
<div class="formContainer">
    <form class="forms">
        <h1>Sign Up</h1>
        <ul class="signUpform">
            <li><input id="firstname" type="text" name="name" placeholder="Enter Name">Name</li>
            <li><input id="uName" type="text" name="Username" placeholder="Create User Name">UserName</li>
